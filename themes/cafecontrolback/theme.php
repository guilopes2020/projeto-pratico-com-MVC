...
<head>
    <meta charset="UTF-8">
        <meta name="mit" content="2023-04-26T15:32:38-03:00+199131">
    ...
    <div class="container content">
        <section class="main_footer_content">
            ...
            <article class="main_footer_content_item social">
                ...
                <a target="_blank" class="icon-instagram" href="https://www.instagram.com" title="CafeControl no Instagram">@CafeControl</a>
                <a target="_blank" class="icon-youtube" href="https://www.youtube.com" title="CafeControl no YouTube">/CafeControl</a>
            </article>
        </section>
    </div>
</footer>
